    ...
    <div className="admin-controller-container">
      <div className="admin-controller-wrapper">
        ...
        >
          <button
            ...
            style={{
              ...
              border: "none",
              background:
                controller.activeTab === "calculations" ? "#007bff" : "#f8f9fa",
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              background:
                controller.activeTab === "messages" ? "#007bff" : "#f8f9fa",
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              background:
                controller.activeTab === "partners" ? "#007bff" : "#f8f9fa",
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              background:
                controller.activeTab === "paymenttypes" ? "#007bff" : "#f8f9fa",
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              background:
                controller.activeTab === "paymentmodes" ? "#007bff" : "#f8f9fa",
              color: controller.activeTab === "paymentmodes" ? "white" : "#333",
              cursor: "pointer",
              fontWeight: "bold",
              borderRadius: "4px 4px 0 0",
            }}
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              background:
                controller.activeTab === "cronjobs" ? "#007bff" : "#f8f9fa",
        ...
        {controller.message.text && (
          <div
            className={`admin-controller-message ${controller.message.type}`}
          >
            {controller.message.text}
          </div>
        )}
        ...
        {/* Tab Content */}
        {controller.activeTab === "calculations" && (
          <CalculationsTab controller={controller} />
        )}
        {controller.activeTab === "messages" && (
          <MessagesTab controller={controller} />
        )}
        {controller.activeTab === "partners" && (
          <PartnersTab controller={controller} />
        )}
